<template>
  <div class="group-product">
    ...
    <div class="text-product">
      <p>
        <router-link class :to="'show/'+`${product.id}`">{{product.title}}</router-link>
        <br />
      ...
      <a class="add-cart" @click.prevent="addToCart(product.id)" type="button">
        <i class="fas fa-cart-plus"></i>
        <i v-if="status.loadingItem === product.id" class="fas fa-spinner fa-spin"></i>
      </a>
    </div>
  </div>
</template>
